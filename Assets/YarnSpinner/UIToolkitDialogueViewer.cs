...
public class UIToolkitDialogueViewer : DialogueViewBase
{
    ...
    [SerializeField] string textboxName;
    ...
    //private UnityEngine.UIElements.Text

    private void Awake()
    {
        Debug.Log("I exist");
        document = GetComponentInParent<UIDocument>(); 
        dialogueText = document.rootVisualElement.Q(textboxName) as Label;
    }
    ...
    public override void RunLine(LocalizedLine dialogueLine, Action onDialogueLineFinished)
    {
        ...
        // text.
        Scale = 0;
        Debug.Log($"Trying to set text {dialogueLine.Text.Text}");
        dialogueText.text = dialogueLine.Text.Text;
